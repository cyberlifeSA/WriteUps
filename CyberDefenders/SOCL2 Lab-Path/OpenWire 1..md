...
![Pasted image 20260704230901](../../Fotos/Pasted%20image%2020260704230901.png)
...
![Pasted image 20260704233445](../../Fotos/Pasted%20image%2020260704233445.png)
...
El parche aplicado a esta vulnerabilidad introduce una validación adicional en la clase **`BaseDataStreamMarshaller`**, con el objetivo de comprobar de forma más estricta si la clase que se está intentando instanciar corresponde al tipo **`Throwable`**. Esta verificación 
extra permite corregir la falla de seguridad al evitar instanciaciones no válidas o potencialmente maliciosas.
