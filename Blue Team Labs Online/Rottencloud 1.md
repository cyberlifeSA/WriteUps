...
A través del análisis del historial de navegación de la instancia EC2 comprometida, el atacante encontró rastros que conducían a un portal web secreto utilizado por personas restringidas. Utilizando correlación cruzada con otras fuentes de registro, identifica la URL 
de este portal secreto.

![Pasted image 20260617133915](../Fotos/Pasted%20image%2020260617133915.png)

**Respuesta:** zeta9-research-portal.azurewebsites.net 
...
**Respuesta:** cmd=curl -H secret:4ebc6d54-f421-4321-81c4-fd9e29d28a0f 'http://169.254.130.3:8081/msi/token?api-version=2017-09-01&resource=https://management.azure.com/'
...
**Respuesta:** quantum-research-secrets
...
**Respuesta:** https://pastebin.com/raw/sBEs83q3