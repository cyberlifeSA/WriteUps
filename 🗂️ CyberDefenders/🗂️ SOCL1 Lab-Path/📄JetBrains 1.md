...
**Respuesta:** a1l4m:youarecompromised
...
De acuerdo con el contexto de la actividad realizada por el atacante sobre los archivos, la subtécnica de **MITRE ATT&CK** correspondiente a la técnica de **Manipulación de Datos** es **Data Manipulation: Stored Data**
...
**Respuesta:** docker run --rm -it -v /:/host ubuntu chroot /host